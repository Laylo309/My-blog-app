...
module Mocks
  def create_users
    names = [
      { name: 'Nelsino', bio: "I'm the last oracle", posts_counter: 0, email: 'jgonzalez.wj@gmail.com', role: 'admin' },
      { name: 'juanito', bio: "I'm the First oracle", posts_counter: 0, email: 'test1@foo.com', role: 'admin' },
